...
print(fp[1000])
pl.plot(f[fbin_ind[0]:(fbin_ind[0]+500)],h1[fbin_ind[0]:(fbin_ind[0]+500)],'r')
pl.plot(f[fbin_ind[0]:(fbin_ind[0]+500)],h_int2[fbin_ind[0]:(fbin_ind[0]+500)],'g')
pl.plot(fp[fbin_ind[0]:(fbin_ind[0]+200)],h1[fbin_ind[0]:(fbin_ind[0]+200)],'b')
pl.savefig("figures/overlap_comp4.pdf")
